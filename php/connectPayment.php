			...
			if(isset($_POST["sub"])){
				...
				//read last payment Id From database
			...
			//calcuate total charges and display in payment detail table
			document.getElementById("totalCharge").innerHTML += pkgcharges + service+".00" ;
			//display total value as total amount in pyment page to insert to database
